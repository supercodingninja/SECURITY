...
var scenario = [
  //0
  ['In the growing rate of crime, internal deception; and medical response needed, incident reports \(IR\'s)\ have never been more vital.  Similar to a Daily Activity Report \(DAR)\, IR\'s carry more weight in the court of law; ince they can/shoul give more acurate details to the situation concerning.  Yes, an IR can and most likely will be used in the court of law, if charges pressed by or against the Client/Security/YOU.'],
  //1
  ['Given a short lesson...asked question...', 'Option A', 'Option B'],
  //2
  ['', '', ''],
  //3
  ['', '', ''],
